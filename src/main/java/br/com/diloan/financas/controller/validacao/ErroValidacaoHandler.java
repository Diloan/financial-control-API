...
public class ErroValidacaoHandler {
    ...
    public ErroFormularioGenericoDTO handlerData(DataIntegrityViolationException exception) {
        return new ErroFormularioGenericoDTO(exception.getLocalizedMessage());
    }
}
